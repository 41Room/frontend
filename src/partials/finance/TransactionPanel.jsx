          ...
          <div className="max-w-sm mx-auto lg:max-w-none">
            ...
            <div className="drop-shadow-lg mt-12">
              ...
              <div className="bg-white rounded-b-xl p-5 pt-2.5 text-sm space-y-3">
                <Link
                  ...
                  to="https://sepolia.etherscan.io/tx/0x734aca73300ff582001105842c9487ef425c6773e43a2d9e1395295fc8c38d61"
                >
                  <span className="italic">Tx:</span>
                  <span className="font-medium text-slate-700 text-right">
                    {`0x734aca73300ff582001105842c9487ef425c6773e43a2d9e1395295fc8c38d61`.slice(
                      0,
                      15
                    )}
                    ...d61
            ...
            <div className="mt-6">
              ...
              <form className="rounded bg-slate-100 border border-dashed border-slate-300 text-center px-5 py-8">
                ...
                <label
                  htmlFor="upload"
                  className="block text-sm text-slate-500 italic"
                >

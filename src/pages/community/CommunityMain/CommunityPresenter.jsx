...
const CommunityMainPresenter = ({ communityList = [] }) => {
  /* Router */
  /* State */
  ...
  /* Hooks */
  /* Render */
  const communityListRender = communityList.map((community) => {
    const { community_id } = community;
    return <CommunityItem key={community_id} community={community} />;
  });
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-5">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                >
                  ...
                  <span className="hidden xs:block ml-2">커뮤니티 등록</span>
                </Link>
              </div>
            </div>
...
export default CommunityMainPresenter;
